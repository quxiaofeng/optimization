...
{% math %} L_0({\bf x}, {\bf \lambda}) = \left\{ \begin{array}{ll} f({\bf x}) + \sum^m_{i=1}\lambda_ig_i({\bf x}), {\bf \lambda} \geqslant {\bf 0}\\ -\infty \text{,   } {\bf \lambda} \ngeqslant {\bf 0} \end{array} \right {% endmath %}
